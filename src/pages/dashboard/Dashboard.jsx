...
//       if (res.data.status) {
//         setLowStockProducts(res.data.data.filter(p => p.stock <= 5));
//       }
//     } catch (e) {
//       console.error(e);
//     }
...
//         `/dashboard/get_dashboard.php?company_id=${company_id}`
//       );
...
//         <Card title="Total Sales" value={stats.total_sales} color="#16a34a" />
//         <Card title="Products" value={stats.total_products} color="#2563eb" />
//         <Card title="Low Stock" value={lowStockProducts.length} color="#dc2626" />
...
//         <Card title="Credit Sales" value={creditStats.total_credit_sales} color="#4f46e5" />
//         <Card title="Outstanding" value={creditStats.total_outstanding} color="#dc2626" />
//         <Card title="Overdue" value={creditStats.overdue_amount} color="#b91c1c" />
//         <Card title="Today Collection" value={creditStats.today_collection} color="#16a34a" />
...
//       <h2 style={{ color }}>{typeof value === "number" ? "₹" + value.toLocaleString() : value}</h2>
//     </div>
//   );
// }
